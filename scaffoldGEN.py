...
def pneumatic(fname,x,y,n,d,shape,side_l,layer_h,layer_n,skirt_i,sdist,feedrate,zsafe):
	# starting g-code
...
def piston(fname,x,y,n,d,shape,side_l,layer_h,layer_n,dist_ext,skirt_i,sdist,feedrate,zsafe,ramp,flow):
